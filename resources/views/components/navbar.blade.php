<nav class="w-full bg-white/80 backdrop-blur-md border-b border-gray-100 flex justify-between items-center px-6 lg:px-10 py-4 sticky top-0 z-50">
    ...
    <div class="hidden md:flex flex-1 max-w-md mx-6">
        <div class="relative w-full">
            ...
            <input type="text" placeholder="Search items..." class="w-full pl-11 pr-4 py-2.5 rounded-full bg-gray-50 border border-gray-100 focus:border-[#52c6be] focus:ring-2 focus:ring-[#52c6be]/20 outline-none transition-all text-sm font-medium text-gray-700">
        </div>
    </div>
        ...
        @auth
            ...
            <div class="relative inline-block text-left">
                ...
                <div id="user-dropdown" class="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 transition-all hidden">
                    ...
                    <a href="/profile" class="flex items-center gap-3 px-4 py-3 text-sm font-bold text-gray-600 hover:bg-gray-50 hover:text-[#52c6be] transition-colors">
                    ...
                    <a href="/my-listings" class="flex items-center gap-3 px-4 py-3 text-sm font-bold text-gray-600 hover:bg-gray-50 hover:text-[#52c6be] transition-colors">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="border-t border-gray-100 mt-2 pt-2">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold text-gray-600 hover:bg-red-50 hover:text-red-500 transition-colors">
                                <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
