            ...
            <div class="flex flex-col py-2 lg:py-6">
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <span
                            class="bg-[#52c6be]/10 text-[#52c6be] px-4 py-1.5 rounded-full font-bold text-xs uppercase tracking-wider">New
                            Arrival</span>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-bold text-gray-900 leading-tight group-hover:text-[#52c6be] transition-colors">
